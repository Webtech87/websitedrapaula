...
const mediaItems: MediaItem[] = [
  // Images
  { type: 'image', src: modulo3, title: "Sala de Formacoes." },
  { type: 'image', src: modulo2, title: "Aulas de Grupo" },
  { type: 'image', src: modulo1, title: "Salas para teoria à prática em terapia ocupacional." },
  { type: 'image', src: modulo4, title: "Formacoes exclusivas." },
  { type: 'image', src: modulo5, title: "Aulas praticas." },
  { type: 'image', src: modulo6, title: "Avaliacao e Raciocínio Clinico." },
  { type: 'image', src: modulo7, title: "Ativadades Individuais e em grupo." },
  { type: 'image', src: modulo8, title: "Salas para ensino" },
  { type: 'image', src: img1, title: "Espaço de convivência." },
  { type: 'image', src: img2, title: "Ambiente acolhedor." },
  { type: 'image', src: img3, title: "Detalhes arquitetônicos." },
  { type: 'image', src: img4, title: "Salas modernas." },
  { type: 'image', src: img5, title: "Equipamentos de última geração." },
  { type: 'image', src: img6, title: "Espaço para eventos." },
  { type: 'image', src: img7, title: "Área de estudos." },
  { type: 'image', src: img8, title: "Laboratório prático." },
  { type: 'image', src: img9, title: "Espaço colaborativo." },
  { type: 'image', src: img10, title: "Ambiente de relaxamento." },
  
  // Videos
  { type: 'video', src: vid3, title: "Atividades práticas", thumbnail: img1 },
  { type: 'video', src: vid5, title: "Aulas em grupo", thumbnail: img2 },
  { type: 'video', src: vid6, title: "Demonstrações", thumbnail: img3 },
  { type: 'video', src: vid7, title: "Espaços de formação", thumbnail: img4 },
  { type: 'video', src: vid8, title: "Equipamentos", thumbnail: img5 },
  { type: 'video', src: vid12, title: "Eventos", thumbnail: img6 },
  { type: 'video', src: vid4, title: "Depoimentos", thumbnail: img7 },
];
        ...
        <div className="carousel-header">
          ...
          <div className="carousel-subtitle-container">
            <p className={`carousel-subtitle ${isTextVisible ? "fade-in" : ""}`}>
              Cada imagem e vídeo conta parte da nossa jornada!
            </p>
          </div>
        </div>
                      ...
                      {item.type === 'image' ? (
                        <>
                          ...
                          <div className="carousel-overlay">
                            ...
                            <span className="carousel-action" onClick={() => openMediaModal(item)}>Ampliar imagem</span>
                          </div>
                        </>
                      ) : (
                        <>
                          <div className="video-container">
                            ...
                            {playingVideoIndex !== index && (
                              <div className="video-overlay" onClick={() => toggleVideoPlay(index)}>
                          ...
                          <div className="carousel-overlay">
                            ...
                            <span className="carousel-action" onClick={() => openMediaModal(item, index)}>Ampliar vídeo</span>
                          </div>
                        </>
                      )}
                    </div>
