...
const ImersaoDetails = () => {
  ...
  // Gallery images
  const galleryImages = [
    "/src/galleryPse/img7.jpeg",
    "/src/galleryPse/img2.jpeg",
    "/src/galleryPse/img3.jpeg",
    "/src/galleryPse/img4.jpeg",
    "/src/galleryPse/img5.jpeg",
    "/src/galleryPse/img6.jpeg",
  ];
  ...
  return (
    ...
    >
      <section 
        ...
        style={{ 
          backgroundImage: "url('/src/galleryPse/img7.jpeg')",
        ...
        <div className="container">
          ...
          <div className="next-steps-content">
            ...
            <div className="next-steps-image">
              <img 
                src="/src/galleryPse/img1.jpeg"  // Update this path to your actual image
