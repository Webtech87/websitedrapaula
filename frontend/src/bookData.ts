...
export const books: Book[] = [
  ...
  },
  {
    ...
    description: "As crianças aprendem a andar, a falar, a comunicar, a autorregular-se, a partilhar e a resolver problemas enquanto experimentam brincadeiras com os outros e com o meio. Ao brincar, recebem informação do corpo e do ambiente circundante através dos seusinformação do corpo e do ambiente circundante através dos seus sistemas sensoriais. Esses sistemas sensoriais, movimentos, pensamentos, emoções e comportamentos são controlados pelo cérebro, que processa continuamente as inúmeras sensações recebidas a cada instante. Acredita-se que o brincar e a integração sensorial evoluem de forma...",
    price: 16.00,
    originalPrice: 24.99,
    category: "impresso",
    rating: 5,
