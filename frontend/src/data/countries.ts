...
export const countries: Country[] = [
  ...
  { code: 'TF', name: 'French Southern Territories', phoneCode: '+' },
  ...
  { code: 'HM', name: 'Heard Island and McDonald Islands', phoneCode: '+' },
  { code: 'VA', name: 'Holy See (Vatican City)', phoneCode: '+379' },
  ...
  { code: 'GS', name: 'South Georgia and South Sandwich Islands', phoneCode: '+' },
  ...
  { code: 'UM', name: 'United States Minor Outlying Islands', phoneCode: '+' },
